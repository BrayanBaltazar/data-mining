...
#
FreeThrowsAttem <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, 
...
colnames(FreeThrowsAttem) <- Seasons
rownames(FreeThrowsAttem) <- Players
...
#
Games <- rbind(KobeBryant_G, JoeJohnson_G, LeBronJames_G, CarmeloAnthony_G, DwightHoward_G, ChrisBosh_G, ChrisPaul_G, 
KevinDurant_G, DerrickRose_G, DwayneWade_G)
rm(KobeBryant_G, JoeJohnson_G, CarmeloAnthony_G, DwightHoward_G, ChrisBosh_G, LeBronJames_G, ChrisPaul_G, DerrickRose_G, 
DwayneWade_G, KevinDurant_G)
...
#
FieldG <- rbind(KobeBryant_FG, JoeJohnson_FG, LeBronJames_FG, CarmeloAnthony_FG, DwightHoward_FG, ChrisBosh_FG, 
ChrisPaul_FG, KevinDurant_FG, DerrickRose_FG, DwayneWade_FG)
rm(KobeBryant_FG, JoeJohnson_FG, LeBronJames_FG, CarmeloAnthony_FG, DwightHoward_FG, ChrisBosh_FG, ChrisPaul_FG, 
KevinDurant_FG, DerrickRose_FG, DwayneWade_FG)

colnames(FieldG) <- Seasons
rownames(FieldG) <- Players
...
#
FieldGoalAttem <- rbind(KobeBryant_FGA, JoeJohnson_FGA, LeBronJames_FGA, CarmeloAnthony_FGA, DwightHoward_FGA, 
ChrisBosh_FGA, ChrisPaul_FGA, KevinDurant_FGA, DerrickRose_FGA, DwayneWade_FGA)
rm(KobeBryant_FGA, JoeJohnson_FGA, LeBronJames_FGA, CarmeloAnthony_FGA, DwightHoward_FGA, ChrisBosh_FGA, 
ChrisPaul_FGA, KevinDurant_FGA, DerrickRose_FGA, DwayneWade_FGA)

colnames(FieldGoalAttem) <- Seasons
rownames(FieldGoalAttem) <- Players

FieldGoalAttem
#

#Points
KobeBryant_P <- c(2832,2430,2323,2201,1970,2078,1616,2133,83,782)
JoeJohnson_P <- c(1653,1426,1779,1688,1619,1312,1129,1170,1245,1154)
LeBronJames_P <- c(2478,2132,2250,2304,2258,2111,1683,2036,2089,1743)
CarmeloAnthony_P <- c(2122,1881,1978,1504,1943,1970,1245,1920,2112,966)
DwightHoward_P <- c(1292,1443,1695,1624,1503,1784,1113,1296,1297,646)
ChrisBosh_P <- c(1572,1561,1496,1746,1678,1438,1025,1232,1281,928)
ChrisPaul_P <- c(1258,1104,1684,1781,841,1268,1189,1186,1185,1564)
KevinDurant_P <- c(903,903,1624,1871,2472,2161,1850,2280,2593,686)
DerrickRose_P <- c(597,597,597,1361,1619,2026,852,0,159,904)
DwayneWade_P <- c(2040,1397,1254,2386,2045,1941,1082,1463,1028,1331)
#Matriz

#
Points <- rbind(KobeBryant_P, JoeJohnson_P, LeBronJames_P, CarmeloAnthony_P, DwightHoward_P, 
ChrisBosh_P, ChrisPaul_P, KevinDurant_P, DerrickRose_P, DwayneWade_P)
rm(KobeBryant_P, JoeJohnson_P, LeBronJames_P, CarmeloAnthony_P, DwightHoward_P, ChrisBosh_P, ChrisPaul_P,
KevinDurant_P, DerrickRose_P, DwayneWade_P)
...
# Hit 1 for the player playing style (Points - FreeThrows) / FieldG

# Hit 2 fill the Blanks

#Matriz for Free Throws
...
rm(KobeBryant_FT, JoeJohnson_FT, CarmeloAnthony_FT, DwightHoward_FT, ChrisBosh_FT, LeBronJames_FT, 
ChrisPaul_FT, DerrickRose_FT, DwayneWade_FT, KevinDurant_FT)
#Rename the columns
colnames(FreeThrows) <- Seasons
#Rename the rows
rownames(FreeThrows) <- Players
...
ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
#Remove vectors - we don't need them anymore
rm(KobeBryant_FTA, JoeJohnson_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, LeBronJames_FTA, 
ChrisPaul_FTA, DerrickRose_FTA, DwayneWade_FTA, KevinDurant_FTA)
#Rename the columns
colnames(FreeThrowsAttem) <- Seasons
#Rename the rows
rownames(FreeThrowsAttem) <- Players
...
myplot((Points- FreeThrows)/ FieldG)
